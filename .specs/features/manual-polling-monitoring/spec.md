...
| --- | --- | --- | --- |
| MP-01 | P1 | Design | Pending |
| MP-02 | P1 | Design | Pending |
| MP-03 | P1 | Design | Pending |
| MP-04 | P1 | Design | Pending |
| MP-05 | P1 | Design | Pending |
| MP-06 | P2 | Design | Pending |
| MP-07 | P2 | Design | Pending |
...
**Coverage:** 20 total, 0 mapped to tasks yet, 20 unmapped ⚠️ (Design/Tasks not yet run).
