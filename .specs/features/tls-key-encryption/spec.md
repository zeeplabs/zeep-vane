...
| --- | --- | --- | --- |
| TLSKEY-01 | P1: Store `.key` sealed | T1 | Pending |
| TLSKEY-02 | P1: Load `.key` decrypted | T1 | Pending |
| TLSKEY-03 | P1: Non-`.key` byte-for-byte passthrough | T1 | Pending |
| TLSKEY-04 | P1: Versioned self-describing envelope | T1 | Pending |
| TLSKEY-05 | P1: Decrypt failure is explicit, not "missing" | T1, T4 | Pending |
| TLSKEY-06 | P1: Legacy plaintext `.key` pass-through | T1 | Pending |
...
| TLSKEY-09 | P2: Full `certmagic.Storage` delegation | T1 | Pending |
