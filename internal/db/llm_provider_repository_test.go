...
func TestLLMProviderRepository_DeleteProvider_ExistingRow_RemovesIt(t *testing.T) {
	repo, _ := newLLMProviderRepoForTest(t)
	ctx := context.Background()
	...
	if err := repo.DeleteProvider(ctx, "openai"); err != nil {
...
func TestLLMProviderRepository_DeleteProvider_NeverConnected_NoError(t *testing.T) {
	repo, _ := newLLMProviderRepoForTest(t)
	ctx := context.Background()
...
func TestLLMProviderRepository_DeleteProvider_ActiveProvider_ClearsActiveProviderViaFK(t *testing.T) {
	repo, _ := newLLMProviderRepoForTest(t)
	ctx := context.Background()
