...
import type { StatusPage } from "../../lib/mockData";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h3 className="text-text">Status Pages</h3>
        {canManage ? (
          <Button
            variant="primary"
            onClick={() => {
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen} title="Criar status page">
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            <Button type="submit" variant="primary" disabled={createStatusPage.isPending}>
              Criar
            </Button>
